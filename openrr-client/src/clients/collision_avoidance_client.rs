...
use openrr_planner::SelfCollisionChecker;
    ...
    T: JointTrajectoryClient,
{
    ...
    fn send_joint_positions(
        ...
        let current = self.collision_checker.using_joints.joint_positions();
        let traj = self
            .planner
            .plan_avoid_self_collision(&self.collision_checker.using_joints, &current, &positions)
    ...
    fn send_joint_trajectory(&self, trajectory: Vec<TrajectoryPoint>) -> Result<WaitFuture, Error> {
        ...
        let positions = self
            ...
            .plan_avoid_self_collision(
                &self.collision_checker.using_joints,
                &current,
