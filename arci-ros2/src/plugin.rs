use crate::{
    Node, NodeOptions, Ros2CmdVelMoveBase, Ros2CmdVelMoveBaseConfig, Ros2ControlClient,
    Ros2ControlConfig, Ros2LaserScan2D, Ros2LaserScan2DConfig, Ros2LocalizationClient,
    Ros2LocalizationClientConfig, Ros2Navigation, Ros2NavigationConfig,
};
...
impl openrr_plugin::Plugin for Ros2Plugin {
    fn new_joint_trajectory_client(
        ...
        let node = Node::new("plugin_ros2_control_node", "/arci_ros2", NodeOptions::new())?;
    ...
    fn new_move_base(&self, args: String) -> Result<Option<Box<dyn arci::MoveBase>>, arci::Error> {
        ...
        let node = Node::new("plugin_cmd_vel_node", "/arci_ros2", NodeOptions::new())?;
    ...
    fn new_navigation(
        ...
        let node = Node::new("plugin_nav2_node", "/arci_ros2", NodeOptions::new())?;
